    ...
    <nav className="navbar navbar-expand-lg ecosmart-navbar">
      <div className="container-fluid px-3 px-lg-4">
        ...
        <Link className="navbar-brand d-flex align-items-center gap-2" to="/">
          ...
          <span className="brand-name">Eco<span className="brand-accent">Smart</span></span>
        </Link>

        {/* Mobile Toggle */}
        <button className="navbar-toggler" type="button"
          data-bs-toggle="collapse" data-bs-target="#ecosmartNav"
          aria-controls="ecosmartNav" aria-expanded="false" aria-label="Toggle navigation">
        ...
        {/* Collapsible — tout regroupé à droite avec ms-auto */}
        <div className="collapse navbar-collapse" id="ecosmartNav">

          {/* ✅ ms-auto pousse tout à droite */}
          <div className="ms-auto d-flex align-items-center gap-2 flex-wrap">

            {/* Liens Register / Login */}
            {!auth && (
              <>
                <Link to="/register" className="nav-link eco-nav-link eco-link-ghost">
                  Register
                </Link>
                <Link to="/login" className="nav-link eco-nav-link eco-link-outline">
                  Login
                </Link>
                <div className="eco-nav-divider d-none d-lg-block" />
              </>
            )}
